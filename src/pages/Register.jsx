...
//           <Form.Item label="First Name" name="firstName" className="form-item">
//             <Input type="text" required />
//           </Form.Item>
//           <Form.Item label="Last Name" name="lastName" className="form-item">
//             <Input type="text" required />
//           </Form.Item>
//         </div>
...
//             <Input type="email" required />
//           </Form.Item>
//           <Form.Item label="Phone" name="contactNo" className="form-item">
//             <Input type="text" required />
//           </Form.Item>
//         </div>
...
//           <Input type="password" required />
//         </Form.Item>
//         <Form.Item label="Confirm Password" name="confirmPassword" className="form-item">
//           <Input type="password" required />
//         </Form.Item>
